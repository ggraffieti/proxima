...
\begin{table}[H]
	...
	\begin{threeparttable}
		\begin{tabular}{|
			...
			\hline
			\textbf{Componente} & \textbf{Incaricato} & \textbf{Priorità} & \textbf{Costo}\tnote{*} \tabularnewline
			\hline
			UsersAuthorizationsService & Alfredo Maffi & Alta & 10 \tabularnewline
			\hline
			FirstAidService & Gabriele Graffieti & Alta & 10 \tabularnewline
			\hline
			Servizio DNS & Manuel Peruzzi & Alta & 10 \tabularnewline
			\hline
			Applicazione Android & Alfredo Maffi & Media & 10 \tabularnewline
			\hline
			Logger & Gabriele Graffieti & Bassa & 10 \tabularnewline
			\hline
			Front server & Manuel Peruzzi & Bassa & 10 \tabularnewline
			\hline
		\end{tabular}
		\begin{tablenotes} \footnotesize
			\item[*] Descrizione del costo. 
		\end{tablenotes}
...
\chapter{Progettazione} \label{design}
...
In questo capitolo verrà ripercorso il lavoro svolto nelle varie fasi del progetto, in modo da valutare l'adeguatezza del processo di sviluppo adottato. Inoltre, sarà possibile esprimere un giudizio sul prodotto finale, valutandone l'aderenza ai requisiti raccolti, oltre a ragionare su possibili ed eventuali sviluppi futuri.
...
\subsection{Aggiunta di un componente al sistema}
\subsection{Aggiornamento della pagina web}
