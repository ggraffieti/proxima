...
Il nuovo componente in questione potrebbe essere un \emph{web server}, contattabile normalmente tramite HTTP o HTTPS nel caso si volesse garantire un livello minimo di sicurezza nelle comunicazioni. Ovviamente esso dovrà poter interagire alla banca dati attraverso il protocollo   
