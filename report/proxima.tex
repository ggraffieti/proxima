...
\begin{table}[h]
	...
	\begin{threeparttable}
		\begin{tabular}{|
			...
			>{\centering}m{.13\textwidth} |}
			\hline
			& Wi-Fi & Bluetooth & BLE & Wi-Fi Direct & Wi-Fi Aware & NFC \tabularnewline
			\hline
			Supporto Android & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark \tabularnewline
			\hline
			Fase di ricerca & \xmark & \cmark & \cmark & \cmark & \cmark & \cmark \tabularnewline
			\hline
			Pairing automatico & \xmark & \xmark & \cmark & \cmark & \cmark & \cmark \tabularnewline
			\hline
			Range (fra 1 e 3 metri) & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \tabularnewline
			\hline
			Identificazione device più vicino & \xmark & \xmark & \xmark & \xmark & \xmark & \cmark \tnote{*} \tabularnewline
			\hline
			Sicurezza a tracciabilità & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark \tabularnewline
			\hline
			Sicurezza a masquerade & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark \tabularnewline
			\hline
			Basso consumo & \xmark & \xmark & \cmark & \xmark & \xmark & \cmark \tabularnewline
			\hline
			Costo & \xmark & \cmark & \cmark & \xmark & \xmark & \cmark \tabularnewline
			\hline
		\end{tabular}
...
\subsubsection{Analisi di tecnologie alternative}
...
\begin{table}[h]
	...
	\begin{threeparttable}
		\begin{tabular}{|
				...
				>{\centering}m{.13\textwidth} |}
			\hline
			& RFID & Onde radio & Infrarossi \tabularnewline
			\hline
			Supporto Android & \xmark & \xmark & \xmark \tabularnewline
			\hline
			Fase di ricerca & \cmark & \xmark & \xmark \tabularnewline
			\hline
			Pairing automatico & \cmark & \xmark & \xmark \tabularnewline
			\hline
			Range (fra 1 e 3 metri) & \cmark & \xmark & \xmark \tabularnewline
			\hline
			Identificazione device più vicino & \xmark & \xmark & \xmark \tabularnewline
			\hline
			Sicurezza a tracciabilità & \cmark & \xmark & \xmark \tabularnewline
			\hline
			Sicurezza a masquerade & \cmark & \xmark & \xmark \tabularnewline
			\hline
...
\begin{description}
	...
	\end{enumerate}
	\item[Sicurezza] : ogni problematica relativa alla sicurezza accennata in \autoref{issues} necessita di un'analisi dettagliata, atta a stabilire se e come la problematica stessa sia risolvibile nella pratica rispettando i requisiti.
	\begin{itemize}
