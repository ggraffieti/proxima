...
\begin{table}[h]
	...
	\begin{threeparttable}
		\begin{tabular}{|
			...
			\hline
			Supporto Android & \xmark & \cmark/\xmark & \xmark \tabularnewline
			\hline
			Fase di ricerca & \cmark & \xmark & \xmark \tabularnewline
			\hline
			Pairing automatico & \cmark & \cmark & \xmark \tabularnewline
			\hline
			Range (fra 1 e 3 metri) & \cmark & \cmark & \xmark \tabularnewline
			\hline
			Identificazione device più vicino & \xmark & \xmark & \xmark \tabularnewline
			\hline
			Sicurezza a tracciabilità & \cmark & \cmark & \xmark \tabularnewline
			\hline
			Sicurezza a masquerade & \cmark & \cmark & \xmark \tabularnewline
			\hline
